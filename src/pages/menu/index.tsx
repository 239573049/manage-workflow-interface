...
import MenuRoleConfig from '../admin/system/menuConfig/index'
interface IMenu {
    [propName: string]: JSX.Element;
}

const Menu: IMenu =  {
    Work: <Work />, Home: <Home />, User: <User />, WorkConfig: <WorkConfig />, Error404: <Error404 />, RoleConfig: <RoleConfig />, UserConfig: <UserConfig />,MenuRoleConfig:<MenuRoleConfig/>
}
